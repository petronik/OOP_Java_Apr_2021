...
public class _exercise_04 {
	public calss Capitals{
		
	}
	public static String initials(String name) {
		String _stringName = name.trim();
		for (int i = 0; i < _stringName.length(); i++) {
			
		}
		char ch = _stringName.charAt(0);
		ch = Character.toUpperCase(ch);
		int space = _stringName.indexOf(' ');
		return _stringName ;
	}


	public static void main(String[] args) {
		Capitals init1 = new Capital();
		init1.initials("bernardo wright");
